...
/**
 * Depois de lida as matrizes, o método subtracao() faz a subtração das matrizes se o método somaSubtracao(que checa se as matrizes possuem o mesmo tamanho) retornar verdadeiro
 * @author Bruno
 */
public class Subtracao {
   ...
   */
  public void subtracao(Leitura leitura) {
